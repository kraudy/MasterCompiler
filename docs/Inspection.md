...
It searches for the compilation target object to extract its metadata and add the params to the compilation command. The params are a suggestion; they are overridden by the Spec params if provided.
