...
public class CompilationPattern {
  ...
  public enum ValCmd { 
    ...
    // CRTRPGPGM
    NOSOURCE , SRC, NOSRC, XREF, NOXREF, GEN, NOGEN, DUMP, NODUMP, SECLVL, NOSECLVL, SRCDBG, NOSRCDBG, NOLSTDBG,

    // RUNSQLSTM
    ERRLIST, NOLIST,

    // CRTSQLRPGI7
    COMMA, PERIOD, SYSVAL, SEQSRC, NOSEQSRC,
    CVTDT, NOCVTDT, SQL, SYS, OPTLOB, NOOPTLOB, NOEXTIND, EXTIND, SYSTIME, NOSYSTIME,
